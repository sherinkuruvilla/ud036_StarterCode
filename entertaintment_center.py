...
# gave them each a name, description,
# image URL and youtube trailer's URL
...
avatar = media.Movie("Avatar",
                     "Avatar is a distant planet with a native alien species" +
                     "colonized by humans",
                     "http://theideasbodega.com.au/wp-content/uploads/2015/" +
                     "01/neytiri_in_avatar_2-wide-do-we-really-need-avatar-2" +
                     "-1024x640.jpeg",
                     "https://www.youtube.com/watch?v=d1_JBMrrYw8&" +
                     "start=84&end=127")

pulimurugan = media.Movie("Pulimurugan",
                          "Malayalam thriller starring Mohan Lal as the " +
                          "catcher of Tiger, PuliMurugan",
                          "http://pressks.com/wp-content/uploads/2016/10/" +
                          "puli-murugan-first-day-collection.jpg",
                          "https://www.youtube.com/watch?v=blQUlD8g4Pk&" +
                          "start=54&end=94")

dhangal = media.Movie("Dhangal",
                      "Award winning Amir Khan hindi cinema about " +
                      "Sisters rise to fame",
                      "http://t3.gstatic.com/images?q=" +
                      "tbn:ANd9GcQIXnFlBKGWT1ByyIu3qfxX6opQX6BmeeU_" +
                      "qsiE3X8rX9ZRr63r",
